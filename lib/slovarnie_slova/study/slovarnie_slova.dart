...
import 'package:rubickk/slovarnie_slova/study/base_of_words_button.dart';
...
class SlovarnieSlovaPage extends StatefulWidget {
  const SlovarnieSlovaPage({Key? key}) : super(key: key);
  
  @override
  State<SlovarnieSlovaPage> createState() => _SlovarnieSlovaPageState();
}

class _SlovarnieSlovaPageState extends State<SlovarnieSlovaPage> {
  bool valuem = false;
  ...
  Widget build(BuildContext context) {
    ...
    containAndDelete(a,b){
          ...
          b.words[a[j][2]]--;
          if(b.words[a[j][2]] <= 0){
            b.words.remove(a[j][2]);
            all_added.get(0).wordsQuestions.remove(a[j][2]);
            all_added.get(0).wordsAnswers.remove(a[j][2]);
            all_added.get(0).wordsMistakes.remove(a[j][2]);
          }
      ...
      actions: [
        TextButton(
          child: Padding(
            ...
            containAndDelete(slovarnie_slova_box.getAt(i).words, all_added.get(0));
            slovarnie_slova_box.deleteAt(i); 
            setState(() {});
            }),
      ],
    ) 
        ...
        ElevatedButton(
          ...
          borderRadius: BorderRadius.circular(Dimensions.addCollectionAlertDialogButtonBR),
            ...
            if(emptyCheckerString.length - emptyCheckerCounter > 0){
                  ...
                  slovarnie_slova_box.add(collection);  
                  setState(() {});                     
                  Navigator.pop(context);
                //  box.clear();
            }
    ...
    return Stack(
      ...
      // fit: StackFit.expand,
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            BaseOfWordsButton(), //////////////////////////////_______BaseOfWordButton_______////////////////////////////////////
                            ...
                            builder: (context,Box _someBox,_){
                              ...
                              rowSizes: [
                                ...
                                for(int k = keys.length-1; k >= 0; k--)              
                                      ...
                                      onLongPress: (){
                                        reallyWantDeleteCollectionDialog(k);                    
                                      },
                                      onPressed: () {
                                        Navigator.push(
                                                      context,
                                                      MaterialPageRoute(builder: (context) => CollectionPage(index: keys[k]),
                                                      ),
                                                    );
                                      },
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            children: [
                                              Flexible(child: MyText(text: slovarnie_slova_box.get(keys[k]).name,
                                                textAlign: TextAlign.center,
                                                size: Dimensions.collectionNameFS),
                                                ),
                                                Switch(
                                                  value: slovarnie_slova_box.get(keys[k]).isAdded,
                                                  ...
                                                  onChanged: (value) {      
                                                  changeIsAdded(slovarnie_slova_box.get(keys[k]), value);                                 
                                                  },
                                                        ),
                                                  ],
                                              ),
        ...
        child: Visibility(
          visible: slovarnie_slova_box.isEmpty,
          child: Column(
