...
class BaseOfWords extends StatelessWidget {
  BaseOfWords({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold( 
      appBar: AppBar(
        ...
        title: MyText(text: AppStrings.baseOfWordsAppBarTitle,
         size: Dimensions.appBarFontSize,
         weight: FontWeight.w700),
        actions: [ AppBarActions(),],
        
      ),
      body: BaseOfWordsBody(),
      );
  }
}

class BaseOfWordsBody extends StatefulWidget {
   
  const BaseOfWordsBody({Key? key}) : super(key: key); 

  @override
  State<BaseOfWordsBody> createState() => _BaseOfWordsBodyState();
}

class _BaseOfWordsBodyState extends State<BaseOfWordsBody> {
                                                      ...
                                                      itemBuilder: (BuildContext context, int index){                               
                                                        ...
                                                        bool isAddedChecker = all_added.get(0).words.containsKey(snapshot.data!.docs[index].id);
                                                          ...
                                                          return Container(                
                                                            ...
                                                            side: isAddedChecker ? BorderSide(color: AppColors.cardWidgetAddedBorderColor, width: 2,)
                                                            ...
                                                            trailing: snapshot.data!.docs[index].get('def') != "" ?
                                                             WordCardButton(id: snapshot.data!.docs[index].id, chapter: 'slovarnie_slova') :
