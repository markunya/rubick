...
class CardsModeUdareniaPage extends StatefulWidget {
  List listOfWords;
  CardsModeUdareniaPage({
    Key? key,
    required this.listOfWords}) : super(key: key);
  @override
  State<CardsModeUdareniaPage> createState() => _CardsModeUdareniaPageState(listOfWords: listOfWords);
}
...
class _CardsModeUdareniaPageState extends State<CardsModeUdareniaPage> {
  var adUnitId = AddUnitIds.studyUd;
  var adRequest = const AdRequest();
  var isLoaded = false;
  InterstitialAd? interstitialAd;
  
  List listOfWords;
  _CardsModeUdareniaPageState({required this.listOfWords});
  int border = 0;
  ...
  Widget build(BuildContext context) {
    int index;
    String cardWord = listOfWords[border][2];
