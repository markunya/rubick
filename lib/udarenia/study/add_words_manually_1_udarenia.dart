...
import 'add_words_manually_2_udarenia.dart';

class MapsInAWMP1{
  static Map<String, bool?> selectedWordsChecker = {};
  static Map<String, String> selectedWordsWords = {};
  static Map<String, String> selectedWordsVariants = {};
  static Map<String, String> selectedWordsAnswers = {};
...
class AddWordsManuallyPageUdarenia extends StatelessWidget {
  int indexOfCollection;
  AddWordsManuallyPageUdarenia({
    Key? key,
  ...
  Widget build(BuildContext context) {
    return Scaffold( 
      ...
      body: AddWordsManuallyPageUdareniaBody(indexOfCollection: indexOfCollection),
      );
  }
}
...
class _AddWordCheckBoxState extends State<AddWordCheckBox> {
  ...
  late bool? isInThisCollection = contain_1(udarenia_box.get(indexOfCollection).words, id) ? null : false;
  ...
  Widget build(BuildContext context, ) {
    ...
    MapsInAWMP1.selectedWordsAnswers[id] = answer;
    MapsInAWMP1.selectedWordsVariants[id] = variants;
    if (hasDef) {
...
class AddWordsManuallyPageUdareniaBody extends StatefulWidget {
  int indexOfCollection;
   AddWordsManuallyPageUdareniaBody(
    {Key? key,
    required this.indexOfCollection,
    }) : super(key: key); 

  @override
  State<AddWordsManuallyPageUdareniaBody> createState() => _AddWordsManuallyPageBody(indexOfCollection: indexOfCollection);
}

class _AddWordsManuallyPageBody extends State<AddWordsManuallyPageUdareniaBody> {
  int indexOfCollection;
                                                        ...
                                                        bool isAddedChecker = all_added_udarenia.get(0).words.containsKey(snapshot.data!.docs[index].id);
                                                          ...
                                                          return Container(                
                                                            ...
                                                            trailing: AddWordCheckBox(
                                                                               ...
                                                                               variants: snapshot.data!.docs[index].get('variants').join('#'),
             ...
             child: Container(                   
              ...
              onPressed:(){
                 if(MapsInAWMP1.counterOfSelectedWords != 0){
                    Navigator.push(
                           context,
                           MaterialPageRoute(builder: (context) => checkChosedWordsPageUdarenia(selectedWordsChecker: MapsInAWMP1.selectedWordsChecker,
                                                                                        selectedWordsWords: MapsInAWMP1.selectedWordsWords,
                                                                                        selectedWordsAnswers: MapsInAWMP1.selectedWordsAnswers,
                                                                                        selectedWordsVariants: MapsInAWMP1.selectedWordsVariants,
